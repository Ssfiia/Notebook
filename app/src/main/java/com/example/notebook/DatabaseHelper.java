...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String tableName = "myNotes"; // поле названия таблицы в БД
    static final String columnId = "id";  // поле колонки для идентификаторов записей в таблице в БД
    ...
    public void deleteAllNotes(String columnId) {
        ...
        long result = database.delete(tableName,"id=?", new String[]{});

        if (result == -1) {
            Toast.makeText(context, "Записи не удалены", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(context, "Записи успешно удалены", Toast.LENGTH_SHORT).show();
        }
